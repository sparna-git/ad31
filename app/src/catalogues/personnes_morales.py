...
class convert_pmorales:
    ...
    def __init__(self,datamarts, dfLieux: pd.DataFrame):
        ...
        __dfdata = datamarts.get_catalogue_personnes_morales()  #load_df("data/others_list/SemSac_personnes_morales.xlsx")
        ...
        __dfdata["json"] = __dfdata.apply(lambda x : self.__json_notice.get_personnes_morales(x),axis=1)
